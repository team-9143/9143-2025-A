...
public final class Constants {
	...
	public final class ElevatorConstants {
		...
		public static final double ELEVATOR_POSITION_CONVERSION = 1.215; // Inches per count (based on encoder resolution and gear ratio)
		public static final double ELEVATOR_VELOCITY_CONVERSION = 1.215 / 60; // Inches per second per count (based on encoder resolution and gear ratio)
		
		// Motion Profile
		public static final double ELEVATOR_MAX_VELOCITY = 20000; // Maximum velocity for the elevator (in encoder units per second)
		public static final double ELEVATOR_MAX_ACCELERATION = 5000; // Maximum acceleration for the elevator (in encoder units per second squared)

		// PID Constants
		public static final double ELEVATOR_kP = 1; // Proportional gain for the elevator's PID controller
		public static final double ELEVATOR_kI = 0.01; // Integral gain for the elevator's PID controller
		public static final double ELEVATOR_kD = 0.01; // Derivative gain for the elevator's PID controller
		public static final double ELEVATOR_kF = 0.0; // Feedforward gain for gravity compensation

		// Position Limits
		public static final double ELEVATOR_MIN_POSITION = -0.25; // Minimum allowed position for the elevator (in inches)
		public static final double ELEVATOR_MAX_POSITION = 53.5; // Maximum allowed position for the elevator (in inches)

		// Allowed Error
		public static final double ELEVATOR_ALLOWED_ERROR = 0.1; // Allowed error threshold for the elevator to be "at target" (in inches)
	 ...
	 * Contains all configuration values, limits, and preset positions.
	 */
	public final class CorAlConstants {
		...
		public static final double CORAL_PIVOT_kI = 0.055; // Integral gain for the pivot motor's PID controller
		public static final double CORAL_PIVOT_kD = 0.03;  // Derivative gain for the pivot motor's PID controller
		public static final double CORAL_PIVOT_kF = 0.00;  // Feedforward gain for gravity compensation
		
		// Pivot Angle Limits
		public static final double CORAL_PIVOT_MIN_ANGLE = -0.5;  // Minimum allowed angle for the pivot (in degrees)
		public static final double CORAL_PIVOT_MAX_ANGLE = 70.0; // Maximum allowed angle for the pivot (in degrees)
		
		// Allowed Error
		public static final double CORAL_PIVOT_ALLOWED_ERROR = 2.0; // Allowed error threshold for the pivot to be "at target" (in degrees)
		...
		public static final double GAME_PIECE_DETECTION_CONFIRMATION_TIME = 0.3; // Time in seconds to confirm detection
		...
		// Roller Speeds
		public static final double CORAL_INTAKE_SPEED = 0.1;  // Speed for intaking coral (normalized output)
		...
		public static final double ALGAE_HOLD_SPEED = -0.025; // Speed for intaking algae (normalized output)
		public static final double ALGAE_SCORE_SPEED = 0.5;   // Speed for scoring algae (normalized output)
